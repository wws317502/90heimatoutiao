<template>
  <div class="layout-aside">
      ...
      <el-menu background-color="#323745" text-color="#adafb5" active-text-color='#353b4e'>
      <el-menu-item index='/home'>首页</el-menu-item>
      <el-submenu index="1">
          <template slot=title><span slot="title">内容管理</span></template>
      ...
      <el-submenu index="2">
          <template slot=title><span slot="title">粉丝管理</span></template>
